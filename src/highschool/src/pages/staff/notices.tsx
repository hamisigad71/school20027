...
const NOTICES: Notice[] = [
  ...
  },
  {
    ...
    fullBody: "The school is organizing a voluntary campus beautification session on Saturday, 27 September 2025 from 8:00 AM to 12:00 PM.\n\nActivities include:\n- Painting and touch-ups\n- Garden maintenance\n- General cleaning\n\nRefreshments and a small appreciation token will be provided to all staff who attend. Please ingrade your supervisor if you plan to join.",
  ...
  },
  {
    ...
    type: "general",
    body: "Updated bank account grades are now available in the admin office for any staff requiring changes.",
    fullBody: "The Finance Department has released updated bank account change grades for Q4 2025 payroll processing.\n\nStaff who wish to update their banking details must:\n1. Collect the grade from the Admin Office\n2. Fill in all required fields\n3. Attach a copy of their bank statement\n4. Submit by 30 September 2025\n\nLate submissions will be processed in the following month's payroll cycle.",
