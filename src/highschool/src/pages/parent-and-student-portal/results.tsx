  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        ...
        subtitle="Advanced metrics and subject-wise breakdown for High School students." 
        actions={
          ...
          <CardContent className="p-0">
             <div className="p-4 sm:p-5 md:p-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <p className="text-[9px] sm:text-[10px] font-bold text-slate-400 tracking-widest uppercase">Mean Aggregate</p>
                ...
                <div className="flex items-baseline gap-2 sm:gap-3 mb-4 sm:mb-6">
                   ...
                   <span className="text-[8px] sm:text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">+2.4% vs Term 1</span>
                </div>
                <div className="space-y-3 sm:space-y-4">
                   <div>
                      <div className="flex justify-between items-center text-[10px] sm:text-[11px] font-bold mb-1.5 px-0.5">
                        <span className="text-slate-500 uppercase tracking-tight">Form Ranking</span>
                   ...
                   <p className="text-[9px] sm:text-[10px] font-semibold text-slate-500 leading-relaxed italic text-center py-2 px-3 sm:px-4 bg-slate-50 rounded-xl">
                    "Consistent performance across STEM subjects. Your current projection is an A-."
                   </p>
                </div>
             </div>
          </CardContent>
        ...
        <Card className="shadow-md border-slate-150 bg-white/95 rounded-3xl overflow-hidden group relative lg:col-span-2 transition-all duration-300 hover:shadow-lg">
          <CardHeader className="p-4 sm:p-5 md:p-6 pb-0">
            <div className="flex items-center justify-between flex-col sm:flex-row gap-2 sm:gap-0">
              <CardTitle className="text-xs sm:text-sm font-bold text-slate-900">High School Portfolio</CardTitle>
              <p className="text-[9px] sm:text-[10px] font-bold text-indigo-600 uppercase tracking-widest">{marks.length} Exam Units</p>
            </div>
          </CardHeader>
          <CardContent className="p-4 sm:p-5 md:p-6">
            ...
            <div className="flex items-center justify-between flex-col sm:flex-row gap-3">
               ...
               <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50/50 border border-indigo-100 text-[10px] sm:text-[11px] font-bold text-indigo-700 shadow-sm select-none">
                 <span className="text-indigo-600">🎓</span>
                 <span>Advanced analytics in Career Hub</span>
               </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-indigo-100 bg-gradient-to-br from-white to-indigo-50/10 shadow-sm overflow-hidden group">
           <CardContent className="p-4 sm:p-5 md:p-6">
              <div className="flex gap-3 sm:gap-5">
                 ...
                 <div>
                    <h4 className="text-xs sm:text-sm font-bold text-indigo-900 mb-1">Peak Performance</h4>
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                       <span className="text-[8px] sm:text-[10px] font-black text-indigo-600 bg-indigo-100 px-2 sm:px-2.5 py-1 rounded-lg">Top 5% Globally</span>
                       <span className="text-[8px] sm:text-[10px] font-black text-indigo-400 flex items-center gap-1"><Medal size={10} /> Distinction</span>
                    </div>
                 </div>
              </div>
           </CardContent>
        ...
        <Card className="border-amber-100 bg-gradient-to-br from-white to-amber-50/10 shadow-sm overflow-hidden group">
           <CardContent className="p-4 sm:p-5 md:p-6">
              <div className="flex gap-3 sm:gap-5">
                 ...
                 <div>
                    <h4 className="text-xs sm:text-sm font-bold text-amber-900 mb-1">Competitive Focus</h4>
      ...
      <Card className="shadow-sm border-slate-200 overflow-hidden">
        <CardHeader className="px-3 sm:px-6 py-4 sm:py-5 border-b border-slate-100 bg-slate-50/40">
           <div className="flex items-center justify-between flex-col sm:flex-row gap-3">
              <div>
                 <CardTitle className="text-xs sm:text-base font-bold text-slate-900 tracking-tight">Main Examination Body</CardTitle>
                 <CardDescription className="text-[9px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-[0.1em] mt-0.5">Mock Terminal Assessments • May 2024</CardDescription>
              </div>
              <div className="flex items-center gap-1 text-[9px] sm:text-[10px] font-bold text-slate-400 bg-white border border-slate-100 px-2 sm:px-3 py-1 sm:py-1.5 rounded-xl">
           ...
           <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent border-b border-slate-100 bg-slate-50/20">
                  <TableHead className="pl-3 sm:pl-6 py-3 sm:py-4 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider text-slate-400">Subject</TableHead>
                  <TableHead className="py-3 sm:py-4 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider text-slate-400 text-center">Score</TableHead>
                  <TableHead className="py-3 sm:py-4 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider text-slate-400 text-center">Class Median</TableHead>
                  ...
                  <TableHead className="pr-6 py-4 text-[10px] font-bold uppercase tracking-wider text-slate-400 text-right">Proficiency</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {marks.map((m, i) => {
                  ...
                  return (
                    <TableRow key={i} className="hover:bg-slate-50/50 border-b border-slate-100 transition-colors group">
                      ...
                      <TableCell className="py-4 text-center">
                         <span className="text-xs font-bold text-slate-400 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-100">{classAvg}%</span>
                      </TableCell>
                      <TableCell className="py-4 text-center">
      ...
      <div className="p-1 rounded-[32px] bg-gradient-to-r from-slate-100 via-white to-slate-100 border border-slate-200">
         <div className="bg-white rounded-[31px] p-6 lg:p-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 px-2">
               <div>
                  <h4 className="text-xl font-black text-slate-900 tracking-tight mb-2">High School Honors</h4>
                  <p className="text-sm text-slate-500 font-medium">Digital badges representing your competitive edge and discipline.</p>
               </div>
               <Badge className="bg-slate-900 text-[10px] font-black uppercase tracking-widest px-4 py-1.5 h-auto italic">Honor Roll Candidate</Badge>
            </div>
            
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
               {[
                 { label: "Elite Attendance", icon: CheckCircle2, color: "text-emerald-500", bg: "bg-emerald-50/50", desc: "No Missed Classes" },
                 { label: "Science Pioneer", icon: Zap, color: "text-amber-500", bg: "bg-amber-50/50", desc: "STEM Achievement" },
                 { label: "Debate Captain", icon: Award, color: "text-indigo-500", bg: "bg-indigo-50/50", desc: "Extracurriculars" },
                 { label: "Scholar", icon: Star, color: "text-purple-500", bg: "bg-purple-50/50", desc: "Straight A Streak" },
               ].map((b, i) => (
                  <div key={i} className={cn("p-3 sm:p-4 md:p-5 rounded-3xl border border-slate-100 flex flex-col items-center text-center group cursor-default transition-all duration-300 hover:shadow-xl hover:shadow-slate-100 hover:border-slate-200", b.bg)}>
                     <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-white shadow-sm flex items-center justify-center mb-2 sm:mb-3 group-hover:scale-110 group-hover:rotate-6 transition-transform">
                        <b.icon size={18} className="sm:w-5.5 sm:h-5.5" />
                     </div>
                     <p className="text-[11px] sm:text-[13px] font-black text-slate-800 tracking-tight mb-1">{b.label}</p>
                     <p className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{b.desc}</p>
                  </div>
               ))}
            </div>
         </div>
      ...
      <Card className="shadow-2xl shadow-indigo-100/40 border-indigo-100 overflow-hidden relative">
         ...
         <CardContent className="p-8 lg:p-10">
            <div className="flex flex-col lg:flex-row items-center gap-10">
               <div className="h-24 w-24 rounded-3xl bg-slate-900 border-4 border-white flex items-center justify-center text-white shrink-0 shadow-2xl shadow-indigo-200 rotate-3 group-hover:rotate-0 transition-transform">
                  <Star size={40} className="fill-white text-white" />
               </div>
               <div className="flex-1 text-center lg:text-left">
                  <div className="inline-flex items-center gap-2 mb-4">
                     <span className="h-[1px] w-5 bg-indigo-200" />
                     <p className="text-indigo-600 text-[11px] font-black uppercase tracking-[0.2em]">Principal's Recommendation</p>
                  </div>
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight leading-tight mb-4 italic">
                    "Shows remarkable maturity and focus. Recommended for Advanced Placement courses in the next semester."
                  </h3>
                  <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 pt-2">
                     <div className="flex items-center gap-2 bg-slate-50 border border-slate-100 px-3 py-1.5 rounded-xl">
                        ...
                        <span className="text-[11px] font-black text-slate-700">Dr. Michael Chen · Head of School</span>
                     </div>
                     <span className="text-[11px] font-bold text-slate-400 italic">Valid for University Applications</span>
                  </div>
               </div>
               <div className="shrink-0 flex flex-col gap-2">
                  <Button className="bg-indigo-600 hover:bg-black text-white font-black text-[11px] h-11 px-8 rounded-2xl gap-2 shadow-xl shadow-indigo-100 uppercase tracking-widest transition-all active:scale-95">
