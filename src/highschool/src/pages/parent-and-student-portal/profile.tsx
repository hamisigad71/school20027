...
import { studentsSeed, currency } from "../../data/mockData";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {/* Background Ingradeation */}
          <Card className="shadow-sm border-slate-200/80">
            <CardHeader className="px-6 pt-5 pb-4 border-b border-slate-100">
              <CardTitle className="text-base font-semibold text-slate-900">Background Ingradeation</CardTitle>
